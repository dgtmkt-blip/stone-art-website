/**
 * Site-wide settings sourced from verified content (v1 site / repository).
 * Nothing here is invented — fields left undefined (e.g. email) were not
 * present in verified source content, so the UI omits them rather than
 * fabricating a value. Fill in when the client supplies it.
 */
export const siteSettings = {
  ...
  contact: {
    ...
    // Not present in verified source content — leave unset rather than invent.
